...
SUBJECTS = {
    1: ("사진일반", ["s1a", "s1b", "s1c", "s1d", "s1e", "s1f", "s1g", "s1h"]),
    2: ("사진재료 및 현상", ["s2a", "s2b", "s2c", "s2d", "s2e", "s2f", "s2g", "s2h"]),
    3: ("사진기계 및 촬영", ["s3a", "s3b", "s3c", "s3d", "s3e", "s3f", "s3g", "s3h"]),
}
